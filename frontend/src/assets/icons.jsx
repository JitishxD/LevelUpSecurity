...
export const DeveloperIcon = ({ className }) => (
...
export const MarketerIcon = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.136a1.76 1.76 0 011.171-2.274l.564-.165a1.76 1.76 0 001.332-1.842V5.882zM12 14a3 3 0 100-6 3 3 0 000 6z" /></svg>
);
